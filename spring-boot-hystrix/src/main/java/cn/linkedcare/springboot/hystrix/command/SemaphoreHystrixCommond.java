 ...
 *
 */
public class SemaphoreHystrixCommond extends HystrixCommand<String>{
	...
	public static final Logger logger  = LoggerFactory.getLogger(SemaphoreHystrixCommond.class);
	
	private HystrixDto dto;
	
	public SemaphoreHystrixCommond(HystrixDto dto){
...
//                .withQueueSizeRejectionThreshold(2))
	...
	protected SemaphoreHystrixCommond(HystrixCommandGroupKey group) {
		super(group);
	}
